...
subprocess.run(['source', '~/.scripts/bash_scripts/pesapal.sh'], shell=True)

CONSUMER_KEY = os.getenv('~/.scripts/bash_scripts/pesapal.sh')
CONSUMER_SECRET = os.getenv('~/.scripts/bash_scripts/pesapal.sh')
